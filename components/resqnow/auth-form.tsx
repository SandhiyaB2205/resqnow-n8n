...
export default function AuthForm({ signup = false }: { signup?: boolean }) {
  ...
  const [values, setValues] = useState({ name: "", email: "", mobile: "", dob: "", password: "", confirm: "", role: "patient" })
