...
import { getCurrentUserRole, registerProvider } from "../../app/actions/resqnow"
...
export default function AuthForm({ signup = false }: { signup?: boolean }) {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    const role = signup ? values.role : await getCurrentUserRole()
    router.push(role === "doctor" ? "/doctor" : "/dashboard"); router.refresh()
  }
