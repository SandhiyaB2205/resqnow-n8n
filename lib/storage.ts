export const STORAGE_KEYS = { session: "resq-session", profile: "resq-profile", records: "resq-records", consents: "resq-consents", audit: "resq-audit", notifications: "resq-notifications", settings: "resq-settings", qr: "resq-qr" } as const
